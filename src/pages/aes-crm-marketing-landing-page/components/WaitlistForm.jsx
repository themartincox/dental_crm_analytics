...
const WaitlistForm = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      {/* Keep this in the DOM for Netlify form detection */}
      {netlifyForm}
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              {!isSuccess && submitError && (
                <div className="p-6 text-sm text-red-600">{submitError}</div>
              )}
              ...
              {!isSuccess && (
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    />
                    {errors.email && <p className="text-xs text-red-600 mt-1">Required</p>}
                  </div>

                  <div className="flex items-center gap-2">
                    <input type="checkbox" {...register('gdprConsent', { required: true })} />
                    <span className="text-sm text-gray-700">I agree to receive updates (GDPR)</span>
                  </div>
                  {errors.gdprConsent && <p className="text-xs text-red-600">Consent required</p>}
